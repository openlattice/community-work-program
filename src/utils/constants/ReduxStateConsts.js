...
export const STATS = {
  ...
  ENROLLMENT_STATUS_COUNTS_FOR_COURT_TYPE: 'enrollmentStatusCountsForCourtType',
  ...
  TOTAL_ENROLLMENTS_FOR_COURT_TYPE: 'totalEnrollmentsForCourtType',
  TOTAL_PARTICIPANTS_BY_COURT_TYPE: 'totalParticipantsByCourtType',
  TOTAL_PARTICIPANTS_FOR_COURT_TYPE: 'totalParticipantsForCourtType',
