...
export const personOne = Map().withMutations((map :Map) => {
  ...
  map.set('age', 25);
  map.set('startDate', '2018-03-01T08:00:00.000Z');
  map.set('sentenceDate', '2018-02-16T08:00:00.000Z');
  map.set('sentenceEndDate', '2018-08-26T08:00:00.000Z');
...
export const personTwo = Map().withMutations((map :Map) => {
  ...
  map.set('sentenceDate', '2018-08-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2018-12-31T07:00:00.000Z');
...
export const personFive = Map().withMutations((map :Map) => {
  ...
  map.set('age', 21);
  map.set('startDate', '');
  map.set('sentenceDate', '2019-08-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-12-31T07:00:00.000Z');
...
export const personSix = Map().withMutations((map :Map) => {
  ...
  map.set('age', 23);
  map.set('startDate', '2018-09-15T07:00:00.000Z');
  map.set('sentenceDate', '2018-09-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2018-12-31T07:00:00.000Z');
...
export const personEight = Map().withMutations((map :Map) => {
  ...
  map.set('age', 18);
  map.set('startDate', '');
  map.set('sentenceDate', '2019-07-06T07:00:00.000Z');
...
export const personNine = Map().withMutations((map :Map) => {
  ...
  map.set('age', 17);
  map.set('startDate', '');
  map.set('sentenceDate', '2019-06-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-08-31T07:00:00.000Z');
  map.set('hoursServed', '0h');
  map.set('requiredHours', '50h');
  map.set('numberOfWarnings', 0);
  map.set('numberOfViolations', 0);
...
export const personTen = Map().withMutations((map :Map) => {
  ...
  map.set('age', 17);
  map.set('startDate', '');
  map.set('sentenceDate', '2019-10-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-12-31T07:00:00.000Z');
  map.set('hoursServed', '0h');
  map.set('requiredHours', '100h');
  map.set('numberOfWarnings', 0);
...
export const personEleven = Map().withMutations((map :Map) => {
  ...
  map.set('age', 19);
  map.set('startDate', '');
  map.set('sentenceDate', '2019-04-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-06-30T07:00:00.000Z');
  map.set('hoursServed', '0h');
  map.set('requiredHours', '25h');
  map.set('numberOfWarnings', 0);
  map.set('numberOfViolations', 0);
...
export const personTwelve = Map().withMutations((map :Map) => {
  ...
  map.set('age', 20);
  map.set('startDate', '2019-05-09T07:00:00.000Z');
  map.set('sentenceDate', '2019-05-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-07-31T07:00:00.000Z');
  map.set('hoursServed', '0h');
...
export const personThirteen = Map().withMutations((map :Map) => {
  ...
  map.set('age', 20);
  map.set('startDate', '2019-08-10T07:00:00.000Z');
  map.set('sentenceDate', '2019-08-06T07:00:00.000Z');
  map.set('sentenceEndDate', '2019-10-31T07:00:00.000Z');
