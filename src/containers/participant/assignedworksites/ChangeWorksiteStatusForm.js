...
const { WORKSITE_PLANS, WORKSITES_BY_WORKSITE_PLAN } = PERSON;
...
class ChangeWorksiteStatusForm extends Component<Props, State> {
...
// $FlowFixMe
export default connect(mapStateToProps, mapDispatchToProps)(ChangeWorksiteStatusForm);
