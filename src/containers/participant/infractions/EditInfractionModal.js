...
const { ACTIONS, EDIT_INFRACTION_EVENT, REQUEST_STATE } = PERSON;
...
const mapStateToProps = (state :Map) => ({
  editInfractionEventRequestState: state.getIn([STATE.PERSON, ACTIONS, EDIT_INFRACTION_EVENT, REQUEST_STATE]),
});
